...
import me.jingbin.neteasemusicui.databinding.ActivityNeteasePlayStickyBinding;
 ...
 */
public class NeteasePlaylistStickyActivity extends AppCompatActivity {
    ...
    private ActivityNeteasePlayStickyBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_netease_play_sticky);
        // 状态栏透明
    ...
    private void setImgHeaderBg() {
        Glide.with(this)
                .load(NeteasePlaylistStickyActivity.IMAGE_URL_LARGE)
                .error(R.drawable.stackblur_default)
                .transform(new BlurTransformation(40, 8))
    ...
    private void setAdapter() {
        ...
        final int headerContentHeight = headerHeight
                - DensityUtil.dip2px(this, 40)
                - StatusBarUtil.getStatusBarHeight(this)
                - DensityUtil.dip2px(this, 54);
        Log.e("---ContentHeight:  ", headerContentHeight + "");
        ...
        binding.recyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
            ...
            public void onScrolled(@NonNull RecyclerView recyclerView, int dx, int dy) {
                ...
                ViewUtil.setMarginHeight(binding.include.getRoot(), Math.abs(totalDy) > headerContentHeight ? -headerContentHeight : totalDy);
                scrollChangeHeader(Math.abs(totalDy) > headerContentHeight ? headerContentHeight : -totalDy);
            }
        });
    }
...
//        Log.e("-----slidingDistance: ", slidingDistance + "");
    ...
    public static void start(Activity context, ImageView imageView, boolean isRV) {
        Intent intent = new Intent(context, NeteasePlaylistStickyActivity.class);
