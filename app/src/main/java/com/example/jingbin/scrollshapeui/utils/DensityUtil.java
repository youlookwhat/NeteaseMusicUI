...
public class DensityUtil {
    ...
    public static void formatHeight(View imageView, float bili, int type, int marginLR, int marginTop, int marginBottom) {
        ...
        layoutParams.setMargins(dip2px(imageView.getContext(), marginLR), dip2px(imageView.getContext(), marginTop),
                dip2px(imageView.getContext(), marginLR), dip2px(imageView.getContext(), marginBottom));
    }
    ...
    public static void formatBannerHeight(View imageView, View view) {
        float displayWidth = getDisplayWidth(imageView.getContext());
